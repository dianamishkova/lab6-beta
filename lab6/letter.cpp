...
//    setTriangle(2, 0, 1, 5);
    ...
    setQuad(8,1,9,11,12);
    setQuad(9,0,8,10,13);
    setQuad(10,13,12,11,10);
    setQuad(11,0,8,9,1);

    setQuad(12,10,13,12,11);
    setQuad(13,14,17,16,15);
    setQuad(14,14,10,13,17);
    setQuad(15,15,11,12,16);
    setQuad(16,14,10,11,15);
    setQuad(17,17,13,12,16);

    setQuad(18,17,16,23,22);
    setQuad(19,18,21,20,19);
    setQuad(20,18,17,16,21);
    setQuad(21,19,20,23,22);
    setQuad(22,18,17,22,19);
    setQuad(23,21,16,23,20);
}
